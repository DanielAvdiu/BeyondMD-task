const Footer = () => {
    return (
        <>
            <footer className="relative inset-x-0 bottom-0 w-full top-[100vh] bg-black text-white flex flex-row space-x-4 py-2 justify-center items-center text-xl bottom-0 left-0 bg-black w-screen h-12">
